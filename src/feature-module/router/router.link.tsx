...
import MockTestCoupon from "../mockTestCoupon/MockTestCoupon";
import StrategyVideo from "../strategyVideo/StrategyVideo";
...
export const publicRoutes = [
  ...
  {
    path: routes.mockTestCoupon,
    element: <MockTestCoupon />,
    route: Route,
  },
  {
  ...
  {
    path: routes.strategyVideo,
    element: <StrategyVideo />,
    route: Route,
  },
  {
