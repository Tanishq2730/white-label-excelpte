...
const PredictionFile: React.FC = () => {
  const [videos, setVideos] = useState<VideoFileType[]>([
    {
      id: 1,
      fileName: "Tanishq-Resume.pdf",
      priority: 4,
      type: "Academic",
      createdDate: "10-05-2025 | 13:21:01",
      file: null,
    },
  ]);
  ...
  const handleSubmit = () => {
    if (!formData.file && !isEdit) return;

    const fileName = formData.file?.name || formData.fileName || "";
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="card shadow-sm h-100">
                    <div className="card-body d-flex justify-content-between align-items-center">
                      ...
                      Do you want to show Excel PTE’s Study File?
                      </span>
                ...
                <div className="col-md-6">
                  <div className="card shadow-sm h-100">
                    <div className="card-body d-flex justify-content-between align-items-center">
                      <span className="fw-semibold">
                      Do you want to add your own Study Files?
                      </span>
                      <div className="form-check form-switch">
                        <input className="form-check-input" type="checkbox" />
                      </div>
